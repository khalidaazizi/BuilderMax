                              ...
                              <div class="row">
                                 <div class="col-md-4">
                                    <div class="container_main">
                                       <img src="{{asset('front/assets/images/img-1.png')}}" alt="" class="image">
                                       <div class="overlay">
                                          <div class="text">
                                 ...
                                 <div class="col-md-4">
                                    <div class="container_main">
                                       <img src="{{asset('front/assets/images/img-2.png')}}" alt="" class="image">
                                       <div class="overlay">
                                          <div class="text">
                                             <h4 class="some_text"><i class="fa fa-link" aria-hidden="true"></i></h4>
                                          </div>
                                 ...
                                 <div class="col-md-4">
                                    <div class="container_main">
                                       <img src="{{asset('front/assets/images/img-3.png')}}" alt="" class="image">
                                       <div class="overlay">
                                          <div class="text">
                                             <h4 class="some_text"><i class="fa fa-link" aria-hidden="true"></i></h4>
                                          </div>
