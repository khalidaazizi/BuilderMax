               ...
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main active">
                        <div class="service_img"><img src="{{asset('front/assets/images/icon-1.png')}}"></div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main">
                        <div class="service_img"><img src="{{asset('front/assets/images/icon-2.png')}}"></div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main">
                        <div class="service_img"><img src="{{asset('front/assets/images/icon-3.png')}}"></div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main">
                        <div class="service_img"><img src="{{asset('front/assets/images/icon-4.png')}}"></div>
